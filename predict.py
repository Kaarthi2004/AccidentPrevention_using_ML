...
class DetectionPredictor(BasePredictor):
    ...
    def write_results(self, idx, preds, batch):
        ...
        for *xyxy, conf, cls in reversed(det):
            ...
            speed = estimatespeed((x_c, y_c), (x_c, y_c))  # Replace (x_c, y_c) with appropriate points
            log_string += f"Detected Speed: {speed} km/h, "
        
        # Calculate the speed here (you can adjust the ppm and time_constant as needed)
